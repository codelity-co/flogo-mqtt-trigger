...
### Flogo CLI
```bash
flogo install github.com/codelity-co/flogo-mqtt-trigger
```
...
```json
{
  "id": "flogo-mqtt-trigger",
  "name": "Codelity Flogo Mqtt Trigger",
  "ref": "github.com/codelity-co/flogo-mqtt-trigger",
  "settings": {
